// src/components/home/StatsPreview.tsx
...
const StatsPreview = ({ stats }: StatsPreviewProps) => {
    const statCards = [
        {
        ...
        <div className="mb-8 sm:mb-12 lg:mb-16">
            ...
            >
                <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">
                    Données mises à jour en temps réel • Dernière actualisation: {new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                </p>
                <div className="flex items-center justify-center space-x-4 mt-2 text-xs text-gray-400">
                    <div className="flex items-center">
                        <div className="w-3 h-3 rounded-full bg-green-500 mr-1 animate-pulse" />
                        <span>En ligne</span>
                    </div>
                    <div className="flex items-center">
                        <div className="w-3 h-3 rounded-full bg-blue-500 mr-1" />
                        <span>{statCards.length} indicateurs</span>
                    </div>
                </div>
            </motion.div>
        </div>
